#!/usr/bin/env bash
# AdaMAS (modified MAS-Quant) train + multimodal eval for Qwen2.5-VL-7B.
#
...
#
# Writes:
#   - outputs_qwen25vl/<run>/...
#   - log/qwen25vl_7b/adamas/run_*.log, status_*.txt, summary_*.{txt,csv}
#
# Usage:
#   bash scripts/run_qwen25vl7b_adamas.sh
#   SMOKE=1 bash scripts/run_qwen25vl7b_adamas.sh
...
OUTPUT_ROOT="${OUTPUT_ROOT:-./outputs_qwen25vl}"
...
LOG_DIR="${ROOT_DIR}/log/qwen25vl_7b/adamas"
...
echo "========================================="
echo "Qwen2.5-VL-7B AdaMAS-Quant  ${STAMP}"
...
{
  echo "Qwen2.5-VL-7B AdaMAS summary  ${STAMP}"
  echo "MODEL_PATH=${MODEL_PATH}"
  echo "OUTPUT_ROOT=${OUTPUT_ROOT}"
  echo "inference_mode=${inference_mode}"
...
echo "========================================="
echo "Qwen2.5-VL-7B AdaMAS finished."
